    ...
    <header className="fixed top-0 left-0 w-full z-50 flex justify-center px-4 pt-4">
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <span className="text-[#fbd072] font-bold text-xl tracking-wide">Koda</span>
        </Link>
        ...
        <Link
          href="#qosul"
          className="hidden md:inline-flex items-center gap-2 text-sm font-medium text-[#fbd072] border border-[#fbd072]/40 hover:border-[#fbd072] hover:bg-[#fbd072]/10 px-5 py-2 rounded-xl transition-all duration-300"
        >
      ...
      <div
        className={`
          fixed inset-0 bg-[#0e0e0e]/95 backdrop-blur-xl z-40
      ...
      >
        ...
        <Link
          ...
          onClick={() => setMenuOpen(false)}
          className={`
            mt-4 inline-flex items-center gap-2 text-lg font-medium text-[#fbd072] border border-[#fbd072]/40
            hover:border-[#fbd072] hover:bg-[#fbd072]/10 px-8 py-3 rounded-xl transition-all duration-300
            ${menuOpen ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}
          `}
